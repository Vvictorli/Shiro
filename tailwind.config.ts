...
const twConfig: Config = {
  ...
  theme: {
    extend: {
      fontFamily: {
        sans: '"LXGW WenKai","LXGW WenKai Screen","LXGW WenKai Screen R","霞鹜文楷","霞鹜文楷 GB",var(--font-sans),system-ui,-apple-system,PingFang SC,"Microsoft YaHei",Segoe UI,Roboto,Helvetica,noto sans sc,hiragino sans gb,"sans-serif",Apple Color Emoji,Segoe UI Emoji,Not Color Emoji',
        serif:
          '"LXGW WenKai","LXGW WenKai Screen","LXGW WenKai Screen R","霞鹜文楷","霞鹜文楷 GB","Noto Serif CJK SC","Noto Serif SC",var(--font-serif),"Source Han Serif SC","Source Han Serif",source-han-serif-sc,SongTi SC,SimSum,"Hiragino Sans GB",system-ui,-apple-system,Segoe UI,Roboto,Helvetica,"Microsoft YaHei","WenQuanYi Micro Hei",sans-serif',
        mono: `"B612 Mono","Cascadia Code PL","FantasqueSansMono Nerd Font",JetBrainsMono,"Fira code Retina","Fira code","Consolas", Monaco, "Hannotate SC", monospace, -apple-system`,
      },
      screens: {
