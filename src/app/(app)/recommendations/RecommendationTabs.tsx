...
export function RecommendationTabs({
  ...
  return (
    <nav
      className={clsxm(
        'sticky top-16 z-10 flex w-fit max-w-full gap-1 overflow-x-auto rounded-full border border-zinc-200/80 bg-white/90 p-1.5 shadow-[0_18px_40px_-30px_rgba(15,23,42,0.2)] backdrop-blur dark:border-zinc-800/80 dark:bg-zinc-950/74',
        className,
      )}
    >
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={`min-w-[3.75rem] shrink-0 rounded-full px-3 py-2 text-center text-sm transition-all md:min-w-16 md:px-3.5 ${
              active
